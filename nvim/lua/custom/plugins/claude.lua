return {
  ...
  config = function()
    ...
    wk.add {
      ...
      { '<leader>cc', desc = 'Claude Code Toggle', mode = { 'n' } },
      { '<leader>ct', desc = 'Claude Code Terminal', mode = { 'n' } },
      { '<leader>cC', desc = 'Claude Code Continue', mode = { 'n' } },
      { '<leader>cV', desc = 'Claude Code Verbose', mode = { 'n' } },
      { '<leader>cr', desc = 'Claude Code Resume', mode = { 'n' } },
    }
  end,
}
